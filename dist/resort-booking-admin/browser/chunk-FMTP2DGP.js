...
// src/app/shared/components/modal-layer/modal-layer.ts
var _c0 = ["modalLayerWrapperRef"];
var _c1 = ["*"];
var _c2 = (a0) => ({ "show": a0 });
var ModalLayer = class _ModalLayer {
   ...
   */
  id = "";
  bgLayer = "bg-gray-light";
  contentPosition = "center";
  modalLayerWrapper;
  get isOpen() {
    return this._coreService.modal.isOpen(this.id);
  }
  static \u0275fac = function ModalLayer_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _ModalLayer)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ModalLayer, selectors: [["app-modal-layer"]], viewQuery: function ModalLayer_Query(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275viewQuery(_c0, 5);
    }
    if (rf & 2) {
      let _t;
      \u0275\u0275queryRefresh(_t = \u0275\u0275loadQuery()) && (ctx.modalLayerWrapper = _t.first);
    }
  }, inputs: { id: [0, "appRegisterModalLayer", "id"], bgLayer: "bgLayer", contentPosition: "contentPosition" }, ngContentSelectors: _c1, decls: 4, vars: 7, consts: [["modalLayerWrapperRef", ""], [3, "ngClass"], [1, "modal-container"]], template: function ModalLayer_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275projectionDef();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ModalLayer, [{
    ...
    type: ViewChild,
    args: ["modalLayerWrapperRef"]
  }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ModalLayer, { className: "ModalLayer", filePath: "src/app/shared/components/modal-layer/modal-layer.ts", lineNumber: 15 });
})();

// src/app/shared/directives/register-modal-layer.ts
var RegisterModalLayer = class _RegisterModalLayer {
  _coreService = inject(CoreFacadeService);
  modalLayerId = "";
  // The ID of the modal layer to register
  openModalOnInit = false;
  // Whether to open the modal immediately after registration
  ngOnInit() {
  ...
  static \u0275fac = function RegisterModalLayer_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _RegisterModalLayer)();
  };
  static \u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({ type: _RegisterModalLayer, selectors: [["", "appRegisterModalLayer", ""]], inputs: { modalLayerId: [0, "appRegisterModalLayer", "modalLayerId"], openModalOnInit: "openModalOnInit" } });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(RegisterModalLayer, [{
    type: Directive,
    args: [{
...
// src/app/shared/directives/src.ts
var AppSrc = class _AppSrc {
  // Inject Services
  _coreService = inject(CoreFacadeService);
  imgBasePath = this._coreService.appConfig.configData.s3BaseUrl;
  publicPath = this._coreService.appConfig.configData.serverUrl;
  base64Regex = /^data:image\/[a-zA-Z]+;base64,/;
  appSrc = "";
  // actual path
  basePath = this.imgBasePath;
  // base path
  ...
  static \u0275fac = function AppSrc_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _AppSrc)();
  };
  static \u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({ type: _AppSrc, selectors: [["", "appSrc", ""]], hostVars: 1, hostBindings: function AppSrc_HostBindings(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275listener("error", function AppSrc_error_HostBindingHandler() {
        return ctx.onError();
      });
    }
    if (rf & 2) {
      \u0275\u0275attribute("src", ctx.src, \u0275\u0275sanitizeUrlOrResourceUrl);
    }
  }, inputs: { appSrc: "appSrc", basePath: "basePath", defaultSrc: "defaultSrc" }, features: [\u0275\u0275NgOnChangesFeature] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AppSrc, [{
    type: Directive,
    args: [{
      selector: "[appSrc]"
    }]
...
var _c03 = ["searchInputWrapRef"];
var _c13 = ["searchInput"];
var SearchInput = class _SearchInput {
  _renderer2;
  ...
  onSearchTerms(event) {
    if (this.searchInputDebounceId)
      clearTimeout(this.searchInputDebounceId);
    this.searchInputDebounceId = setTimeout(() => {
      this.onSearch.emit(this.searchTerms?.trim()?.toLowerCase());
    }, event ? this.debounceTime : 0);
  }
  static \u0275fac = function SearchInput_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _SearchInput)(\u0275\u0275directiveInject(Renderer2));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SearchInput, selectors: [["app-search-input"]], viewQuery: function SearchInput_Query(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275viewQuery(_c03, 5);
      \u0275\u0275viewQuery(_c13, 5);
    }
    if (rf & 2) {
      let _t;
      \u0275\u0275queryRefresh(_t = \u0275\u0275loadQuery()) && (ctx.searchInputWrap = _t.first);
      \u0275\u0275queryRefresh(_t = \u0275\u0275loadQuery()) && (ctx.searchInput = _t.first);
    }
  }, hostBindings: function SearchInput_HostBindings(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275listener("keydown", function SearchInput_keydown_HostBindingHandler($event) {
        return ctx.handleKeydown($event);
      }, \u0275\u0275resolveWindow);
    }
  }, inputs: { searchTerms: "searchTerms", placeholder: "placeholder", debounceTime: "debounceTime", ngStyles: [0, "styles", "ngStyles"] }, outputs: { onSearch: "onSearch", onclick: "onClick" }, decls: 6, vars: 3, consts: [["searchInputWrapRef", ""], ["searchInput", ""], [1, "search-input-wrap", 3, "click"], ["xmlns", "http://www.w3.org/2000/svg", "width", "16", "height", "16", "viewBox", "0 0 16 16", "fill", "none", 1, "search-icon"], ["d", "M7.4 2C10.3808 2 12.8 4.4192 12.8 7.4C12.8 10.3808 10.3808 12.8 7.4 12.8C4.4192 12.8 2 10.3808 2 7.4C2 4.4192 4.4192 2 7.4 2ZM7.4 11.6C9.7202 11.6 11.6 9.7202 11.6 7.4C11.6 5.0792 9.7202 3.2 7.4 3.2C5.0792 3.2 3.2 5.0792 3.2 7.4C3.2 9.7202 5.0792 11.6 7.4 11.6ZM12.491 11.6426L14.1884 13.3394L13.3394 14.1884L11.6426 12.491L12.491 11.6426Z", "fill", "#A3A3A3"], ["type", "text", "name", "searchTerms", 1, "search-input", 3, "ngModelChange", "ngModel", "placeholder"]], template: function SearchInput_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
      \u0275\u0275elementStart(0, "div", 2, 0);
      \u0275\u0275listener("click", function SearchInput_Template_div_click_0_listener($event) {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.focusSearchInput($event));
      });
      \u0275\u0275namespaceSVG();
      ...
      \u0275\u0275twoWayListener("ngModelChange", function SearchInput_Template_input_ngModelChange_4_listener($event) {
        \u0275\u0275restoreView(_r1);
        \u0275\u0275twoWayBindingSet(ctx.searchTerms, $event) || (ctx.searchTerms = $event);
        return \u0275\u0275resetView($event);
      });
      \u0275\u0275listener("ngModelChange", function SearchInput_Template_input_ngModelChange_4_listener($event) {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.onSearchTerms($event));
      });
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
  ...
  }, dependencies: [FormsModule, DefaultValueAccessor, NgControlStatus, NgModel], styles: ['@import "https://fonts.googleapis.com/css2?family=Inter:wght@100..900&display=swap";\n@import "https://fonts.googleapis.com/css2?family=Nunito+Sans:wght@200;400;600;700;800&display=swap";\n\n\n\n[_ngcontent-%COMP%]:root {\n  --color-primary: #0B0BCF;\n  --color-primary-400: #5386E4;\n  --color-primary-50: #ECECFE;\n  --color-accent: #F8A41D;\n  --color-text: #141C25;\n  --color-border: rgb(216, 216, 255);\n  --color-divider: rgb(236, 236, 254);\n  --surface-weak: rgba(236, 236, 254, 0.5);\n}\n.search-input-wrap[_ngcontent-%COMP%] {\n  padding: 8px 12px;\n  justify-content: flex-start;\n  align-items: center;\n  gap: 8px;\n  display: flex;\n  border-radius: 6px 6px 0 0;\n  background: #FFF;\n  box-shadow: 0px 1px 2px 0px rgba(10, 13, 20, 0.03);\n}\n.search-input-wrap[_ngcontent-%COMP%]   .search-icon[_ngcontent-%COMP%] {\n  flex-shrink: 0;\n  width: 20px;\n  height: 20px;\n}\n.search-input-wrap[_ngcontent-%COMP%]   .search-input[_ngcontent-%COMP%] {\n  flex: 1;\n  margin: 0;\n  padding: 0;\n  width: 100%;\n  border: none;\n  outline: none;\n  color: var(--bs-body-color, #000);\n  background: transparent;\n}\n.search-input-wrap[_ngcontent-%COMP%]   .search-input[_ngcontent-%COMP%]::-webkit-input-placeholder {\n  color: #A3A3A3;\n}\n.search-input-wrap[_ngcontent-%COMP%]   .search-input[_ngcontent-%COMP%]::-moz-placeholder {\n  color: #A3A3A3;\n}\n.search-input-wrap[_ngcontent-%COMP%]   .search-input[_ngcontent-%COMP%]:-ms-input-placeholder {\n  color: #A3A3A3;\n}\n.search-input-wrap[_ngcontent-%COMP%]   .search-input[_ngcontent-%COMP%]::-ms-input-placeholder {\n  color: #A3A3A3;\n}\n.search-input-wrap[_ngcontent-%COMP%]   .search-input[_ngcontent-%COMP%]::placeholder {\n  color: #A3A3A3;\n}\n/*# sourceMappingURL=search-input.css.map */'] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SearchInput, [{
    type: Component,
    args: [{ selector: "app-search-input", imports: [
      FormsModule
    ], template: '<div class="search-input-wrap" (click)="focusSearchInput($event)" #searchInputWrapRef>\n    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none" class="search-icon">\n        <path\n            d="M7.4 2C10.3808 2 12.8 4.4192 12.8 7.4C12.8 10.3808 10.3808 12.8 7.4 12.8C4.4192 12.8 2 10.3808 2 7.4C2 4.4192 4.4192 2 7.4 2ZM7.4 11.6C9.7202 11.6 11.6 9.7202 11.6 7.4C11.6 5.0792 9.7202 3.2 7.4 3.2C5.0792 3.2 3.2 5.0792 3.2 7.4C3.2 9.7202 5.0792 11.6 7.4 11.6ZM12.491 11.6426L14.1884 13.3394L13.3394 14.1884L11.6426 12.491L12.491 11.6426Z"\n            fill="#A3A3A3" />\n    </svg>\n\n    <input #searchInput class="search-input" type="text" name="searchTerms" [(ngModel)]="searchTerms"\n        (ngModelChange)="onSearchTerms($event)" placeholder="{{placeholder}}">\n</div>', styles: ['@import "https://fonts.googleapis.com/css2?family=Inter:wght@100..900&display=swap";\n@import "https://fonts.googleapis.com/css2?family=Nunito+Sans:wght@200;400;600;700;800&display=swap";\n\n/* src/app/shared/components/search-input/search-input.scss */\n:root {\n  --color-primary: #0B0BCF;\n  --color-primary-400: #5386E4;\n  --color-primary-50: #ECECFE;\n  --color-accent: #F8A41D;\n  --color-text: #141C25;\n  --color-border: rgb(216, 216, 255);\n  --color-divider: rgb(236, 236, 254);\n  --surface-weak: rgba(236, 236, 254, 0.5);\n}\n.search-input-wrap {\n  padding: 8px 12px;\n  justify-content: flex-start;\n  align-items: center;\n  gap: 8px;\n  display: flex;\n  border-radius: 6px 6px 0 0;\n  background: #FFF;\n  box-shadow: 0px 1px 2px 0px rgba(10, 13, 20, 0.03);\n}\n.search-input-wrap .search-icon {\n  flex-shrink: 0;\n  width: 20px;\n  height: 20px;\n}\n.search-input-wrap .search-input {\n  flex: 1;\n  margin: 0;\n  padding: 0;\n  width: 100%;\n  border: none;\n  outline: none;\n  color: var(--bs-body-color, #000);\n  background: transparent;\n}\n.search-input-wrap .search-input::-webkit-input-placeholder {\n  color: #A3A3A3;\n}\n.search-input-wrap .search-input::-moz-placeholder {\n  color: #A3A3A3;\n}\n.search-input-wrap .search-input:-ms-input-placeholder {\n  color: #A3A3A3;\n}\n.search-input-wrap .search-input::-ms-input-placeholder {\n  color: #A3A3A3;\n}\n.search-input-wrap .search-input::placeholder {\n  color: #A3A3A3;\n}\n/*# sourceMappingURL=search-input.css.map */\n'] }]
  }], () => [{ type: Renderer2 }], { searchTerms: [{
    type: Input,
    args: ["searchTerms"]
  }], placeholder: [{
    type: Input,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SearchInput, { className: "SearchInput", filePath: "src/app/shared/components/search-input/search-input.ts", lineNumber: 13 });
})();

// src/app/shared/components/common-dropdown/common-dropdown.ts
var _c04 = (a0) => ({ $implicit: a0 });
function CommonDropdown_Conditional_3_Conditional_0_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainer(0);
  }
}
function CommonDropdown_Conditional_3_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ul", 7);
    \u0275\u0275template(1, CommonDropdown_Conditional_3_Conditional_0_ng_container_1_Template, 1, 0, "ng-container", 9);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    \u0275\u0275nextContext(2);
    const optionListTemplate_r1 = \u0275\u0275reference(5);
    \u0275\u0275advance();
    \u0275\u0275property("ngTemplateOutlet", optionListTemplate_r1);
  }
}
function CommonDropdown_Conditional_3_Conditional_1_ng_container_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainer(0);
  }
}
function CommonDropdown_Conditional_3_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "ul", 10)(1, "div", 11)(2, "div", 12)(3, "app-search-input", 13);
    \u0275\u0275listener("onSearch", function CommonDropdown_Conditional_3_Conditional_1_Template_app_search_input_onSearch_3_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.onSearchTerms($event));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275template(4, CommonDropdown_Conditional_3_Conditional_1_ng_container_4_Template, 1, 0, "ng-container", 9);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    const optionListTemplate_r1 = \u0275\u0275reference(5);
    \u0275\u0275classMap(ctx_r2.listWrapClass);
    \u0275\u0275advance(4);
    \u0275\u0275property("ngTemplateOutlet", optionListTemplate_r1);
  }
}
function CommonDropdown_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, CommonDropdown_Conditional_3_Conditional_0_Template, 2, 1, "ul", 7)(1, CommonDropdown_Conditional_3_Conditional_1_Template, 5, 3, "ul", 8);
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275conditional(ctx_r2.disableSearch ? 0 : 1);
  }
}
function CommonDropdown_ng_template_4_Conditional_0_For_1_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainer(0);
  }
}
function CommonDropdown_ng_template_4_Conditional_0_For_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, CommonDropdown_ng_template_4_Conditional_0_For_1_ng_container_0_Template, 1, 0, "ng-container", 15);
  }
  if (rf & 2) {
    const option_r5 = ctx.$implicit;
    \u0275\u0275nextContext(3);
    const simpleOptionBlock_r6 = \u0275\u0275reference(7);
    \u0275\u0275property("ngTemplateOutlet", simpleOptionBlock_r6)("ngTemplateOutletContext", \u0275\u0275pureFunction1(2, _c04, option_r5));
  }
}
function CommonDropdown_ng_template_4_Conditional_0_ForEmpty_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainer(0, 14);
  }
  if (rf & 2) {
    \u0275\u0275nextContext(3);
    const emptyBlock_r4 = \u0275\u0275reference(13);
    \u0275\u0275property("ngTemplateOutlet", emptyBlock_r4);
  }
}
function CommonDropdown_ng_template_4_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275repeaterCreate(0, CommonDropdown_ng_template_4_Conditional_0_For_1_Template, 1, 4, "ng-container", null, \u0275\u0275componentInstance().trackByUniqueKey, true, CommonDropdown_ng_template_4_Conditional_0_ForEmpty_2_Template, 1, 1, "ng-container", 14);
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275repeater(ctx_r2.filteredList);
  }
}
function CommonDropdown_ng_template_4_Conditional_1_For_1_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainer(0);
  }
}
function CommonDropdown_ng_template_4_Conditional_1_For_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, CommonDropdown_ng_template_4_Conditional_1_For_1_ng_container_0_Template, 1, 0, "ng-container", 15);
  }
  if (rf & 2) {
    const option_r7 = ctx.$implicit;
    \u0275\u0275nextContext(3);
    const itemBlockThumb_r8 = \u0275\u0275reference(9);
    \u0275\u0275property("ngTemplateOutlet", itemBlockThumb_r8)("ngTemplateOutletContext", \u0275\u0275pureFunction1(2, _c04, option_r7));
  }
}
function CommonDropdown_ng_template_4_Conditional_1_ForEmpty_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainer(0, 14);
  }
  if (rf & 2) {
...
function CommonDropdown_ng_template_4_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275repeaterCreate(0, CommonDropdown_ng_template_4_Conditional_1_For_1_Template, 1, 4, "ng-container", null, \u0275\u0275componentInstance().trackByUniqueKey, true, CommonDropdown_ng_template_4_Conditional_1_ForEmpty_2_Template, 1, 1, "ng-container", 14);
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275repeater(ctx_r2.filteredList);
...
function CommonDropdown_ng_template_4_Conditional_2_For_1_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainer(0);
  }
}
function CommonDropdown_ng_template_4_Conditional_2_For_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, CommonDropdown_ng_template_4_Conditional_2_For_1_ng_container_0_Template, 1, 0, "ng-container", 15);
  }
  if (rf & 2) {
    const option_r9 = ctx.$implicit;
    \u0275\u0275nextContext(3);
    const itemBlock_r10 = \u0275\u0275reference(11);
    \u0275\u0275property("ngTemplateOutlet", itemBlock_r10)("ngTemplateOutletContext", \u0275\u0275pureFunction1(2, _c04, option_r9));
  }
}
function CommonDropdown_ng_template_4_Conditional_2_ForEmpty_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainer(0, 14);
  }
  if (rf & 2) {
...
function CommonDropdown_ng_template_4_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275repeaterCreate(0, CommonDropdown_ng_template_4_Conditional_2_For_1_Template, 1, 4, "ng-container", null, \u0275\u0275componentInstance().trackByUniqueKey, true, CommonDropdown_ng_template_4_Conditional_2_ForEmpty_2_Template, 1, 1, "ng-container", 14);
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275repeater(ctx_r2.filteredList);
...
function CommonDropdown_ng_template_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, CommonDropdown_ng_template_4_Conditional_0_Template, 3, 1)(1, CommonDropdown_ng_template_4_Conditional_1_Template, 3, 1)(2, CommonDropdown_ng_template_4_Conditional_2_Template, 3, 1);
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275conditional(!ctx_r2.thumbKey && !ctx_r2.displayKey1 ? 0 : ctx_r2.thumbKey ? 1 : 2);
  }
}
function CommonDropdown_ng_template_6_Template(rf, ctx) {
  if (rf & 1) {
    const _r11 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "li", 16);
    \u0275\u0275listener("click", function CommonDropdown_ng_template_6_Template_li_click_0_listener() {
      const option_r12 = \u0275\u0275restoreView(_r11).$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.onOptionChange(option_r12));
    });
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275classProp("bg-secondary-subtle", ctx_r2.isSelected(option_r12));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", option_r12, " ");
  }
}
function CommonDropdown_ng_template_8_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275property("title", option_r14[ctx_r2.displayKey2]);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", option_r14[ctx_r2.displayKey2], " ");
  }
}
function CommonDropdown_ng_template_8_Template(rf, ctx) {
  if (rf & 1) {
    const _r13 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "li", 18);
    \u0275\u0275listener("click", function CommonDropdown_ng_template_8_Template_li_click_0_listener() {
      const option_r14 = \u0275\u0275restoreView(_r13).$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.onOptionChange(option_r14));
    });
    \u0275\u0275elementStart(1, "div", 19)(2, "span", 20);
    \u0275\u0275element(3, "img", 21);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "span", 22)(5, "span", 23);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(7, CommonDropdown_ng_template_8_Conditional_7_Template, 2, 2, "small", 24);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const option_r14 = ctx.$implicit;
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275classProp("bg-secondary-subtle", ctx_r2.isSelected(option_r14));
    \u0275\u0275advance(3);
    \u0275\u0275property("appSrc", option_r14[ctx_r2.thumbKey]);
    \u0275\u0275advance(2);
    \u0275\u0275property("title", option_r14[ctx_r2.displayKey1]);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", option_r14[ctx_r2.displayKey1], " ");
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.displayKey2 ? 7 : -1);
  }
}
function CommonDropdown_ng_template_10_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", option_r16[ctx_r2.displayKey2], " ");
  }
}
function CommonDropdown_ng_template_10_Template(rf, ctx) {
  if (rf & 1) {
    const _r15 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "li", 16);
    \u0275\u0275listener("click", function CommonDropdown_ng_template_10_Template_li_click_0_listener() {
      const option_r16 = \u0275\u0275restoreView(_r15).$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.onOptionChange(option_r16));
    });
    \u0275\u0275elementStart(1, "span", 25)(2, "span", 17);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(4, CommonDropdown_ng_template_10_Conditional_4_Template, 2, 1, "small", 26);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const option_r16 = ctx.$implicit;
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275classProp("bg-secondary-subtle", ctx_r2.isSelected(option_r16));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", option_r16[ctx_r2.displayKey1], " ");
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.displayKey2 ? 4 : -1);
  }
}
function CommonDropdown_ng_template_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li")(1, "span", 27);
    \u0275\u0275text(2, " No records found. ");
    \u0275\u0275elementEnd()();
  }
}
var CommonDropdown = class _CommonDropdown {
  placeholder = "";
  optionsList = [];
  selectedOption;
  uniqueKey = "_id";
  ...
  get displayText() {
    if (!this.selectedOption)
      return "";
    else if (this.displayKey1 && this.displayKey2)
      return `${this.selectedOption[this.displayKey1] ?? ""} (${this.selectedOption[this.displayKey2] ?? ""})`.trim();
  ...
  onSearchTerms(event) {
    ...
    if (this.filterKeys.length > 0) {
      this.filteredList = this.optionsList?.filter((item) => this.filterKeys.some((key) => {
        return item?.[key]?.toLowerCase().includes(event);
      })) || [];
    } else {
      this.filteredList = this.optionsList?.filter((item) => {
  ...
  static \u0275fac = function CommonDropdown_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _CommonDropdown)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CommonDropdown, selectors: [["app-common-dropdown"]], inputs: { placeholder: "placeholder", optionsList: "optionsList", selectedOption: "selectedOption", uniqueKey: "uniqueKey", displayKey1: "displayKey1", displayKey2: "displayKey2", thumbKey: "thumbKey", filterKeys: "filterKeys", disableSameSelect: "disableSameSelect", enableSameSelectRemove: "enableSameSelectRemove", disableSearch: "disableSearch", disabled: "disabled", listWrapClass: "listWrapClass", btnClass: "btnClass", btnStyle: "btnStyle", usedInModal: "usedInModal" }, outputs: { onSelect: "onSelect" }, features: [\u0275\u0275NgOnChangesFeature], decls: 14, vars: 9, consts: [["optionListTemplate", ""], ["simpleOptionBlock", ""], ["itemBlockThumb", ""], ["itemBlock", ""], ["emptyBlock", ""], [1, "dropdown"], ["type", "button", 1, "btn", "btn-light", "w-100", "dropdown-toggle", "text-capitalize", "selected-option", 3, "disabled"], [1, "dropdown-menu", "w-100"], [1, "dropdown-menu", "pt-0", "w-100", 3, "class"], [4, "ngTemplateOutlet"], [1, "dropdown-menu", "pt-0", "w-100"], [1, "search-list-height", "position-relative"], [1, "bg-secondary-subtle", "position-sticky", "top-0", "border-bottom", "mb-2"], [3, "onSearch"], [3, "ngTemplateOutlet"], [4, "ngTemplateOutlet", "ngTemplateOutletContext"], [1, "dropdown-item", 3, "click"], [1, "text-capitalize", "lh-sm", "option-item"], [1, "dropdown-item", "px-2", 3, "click"], [1, "d-flex", "align-items-center", "gap-2"], [1, "flex-shrink-0", "w-100", "custom-ratio-1x1", 2, "max-width", "48px"], ["alt", "", 1, "img-cover", "rounded", 3, "appSrc"], [1, "flex-grow-1", "d-flex", "flex-column"], [1, "text-capitalize", "option-item", 3, "title"], [1, "text-capitalize", "lh-base", "option-item", 3, "title"], [1, "d-flex", "flex-column"], [1, "text-capitalize", "text-muted", "lh-1", "option-item"], [1, "d-block", "py-1", "px-3", "text-capitalize", "text-center", "text-muted"]], template: function CommonDropdown_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 5)(1, "button", 6);
      \u0275\u0275text(2);
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(3, CommonDropdown_Conditional_3_Template, 2, 1);
      \u0275\u0275elementEnd();
      \u0275\u0275template(4, CommonDropdown_ng_template_4_Template, 3, 1, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(6, CommonDropdown_ng_template_6_Template, 3, 3, "ng-template", null, 1, \u0275\u0275templateRefExtractor)(8, CommonDropdown_ng_template_8_Template, 8, 6, "ng-template", null, 2, \u0275\u0275templateRefExtractor)(10, CommonDropdown_ng_template_10_Template, 5, 4, "ng-template", null, 3, \u0275\u0275templateRefExtractor)(12, CommonDropdown_ng_template_12_Template, 3, 0, "ng-template", null, 4, \u0275\u0275templateRefExtractor);
    }
    if (rf & 2) {
      \u0275\u0275advance();
...
<ng-template #optionListTemplate>
    ...
    @for(option of filteredList; track trackByUniqueKey(i, option); let i = $index;){
    <ng-container *ngTemplateOutlet="itemBlockThumb; context: { $implicit: option }"></ng-container>
    }@empty {
    <ng-container [ngTemplateOutlet]="emptyBlock"></ng-container>
    }
    }@else {
...
<!-- Item(thumb) Block Template -->
<ng-template #itemBlockThumb let-option>
    <li class="dropdown-item px-2" (click)="onOptionChange(option)" [class.bg-secondary-subtle]="isSelected(option)">
        <div class="d-flex align-items-center gap-2">
            <span class="flex-shrink-0 w-100 custom-ratio-1x1" style="max-width: 48px;">
                <img [appSrc]="option[thumbKey]" alt="" class="img-cover rounded">
            </span>
            <span class="flex-grow-1 d-flex flex-column">
                <span class="text-capitalize option-item" [title]="option[displayKey1]">
                    {{option[displayKey1]}}
                </span>
                @if(displayKey2){
                <small class="text-capitalize lh-base option-item" [title]="option[displayKey2]">
                    {{option[displayKey2]}}
                </small>
                }
            </span>
...
</ng-template>`, styles: ['@import "https://fonts.googleapis.com/css2?family=Inter:wght@100..900&display=swap";\n@import "https://fonts.googleapis.com/css2?family=Nunito+Sans:wght@200;400;600;700;800&display=swap";\n\n/* src/app/shared/components/common-dropdown/common-dropdown.scss */\n:root {\n  --color-primary: #0B0BCF;\n  --color-primary-400: #5386E4;\n  --color-primary-50: #ECECFE;\n  --color-accent: #F8A41D;\n  --color-text: #141C25;\n  --color-border: rgb(216, 216, 255);\n  --color-divider: rgb(236, 236, 254);\n  --surface-weak: rgba(236, 236, 254, 0.5);\n}\n.selected-option {\n  display: -webkit-box;\n  -webkit-box-orient: vertical;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  line-clamp: 1;\n  -webkit-line-clamp: 1;\n  word-break: break-all;\n  white-space: normal;\n}\n.option-item {\n  display: -webkit-box;\n  -webkit-box-orient: vertical;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  line-clamp: 1;\n  -webkit-line-clamp: 1;\n  word-break: break-all;\n  white-space: normal;\n  cursor: pointer;\n}\n/*# sourceMappingURL=common-dropdown.css.map */\n'] }]
  }], null, { placeholder: [{
    type: Input,
    args: ["placeholder"]
  }], optionsList: [{
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CommonDropdown, { className: "CommonDropdown", filePath: "src/app/shared/components/common-dropdown/common-dropdown.ts", lineNumber: 18 });
})();
...
//# sourceMappingURL=chunk-FMTP2DGP.js.map
